...
class appDevDebugProjectContainer extends Container
{
    ...
    {
        return $this->services['annotation_reader'] = new \Doctrine\Common\Annotations\FileCacheReader(new \Doctrine\Common\Annotations\AnnotationReader(), '/Users/emilioalvarez/www/SimpleAdmin/app/cache/dev/annotations', true);
    }
    ...
    protected function getAssetic_AssetManagerService()
    {
        ...
        $this->services['assetic.asset_manager'] = $instance = new \Assetic\Factory\LazyAssetManager($this->get('assetic.asset_factory'), array('twig' => new \Assetic\Factory\Loader\CachedFormulaLoader(new \Assetic\Extension\Twig\TwigFormulaLoader($this->get('twig')), new \Assetic\Cache\ConfigCache('/Users/emilioalvarez/www/SimpleAdmin/app/cache/dev/assetic/config'), true), 'sp_config' => new \Symfony\Bundle\AsseticBundle\Factory\Loader\ConfigurationLoader()));

        $instance->addResource($this->get('sp_bower.assetic.bower_resource'), 'sp_config');
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\CoalescingDirectoryResource(array(0 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'SimpleAdminBundle', '/Users/emilioalvarez/www/SimpleAdmin/app/Resources/SimpleAdminBundle/views', '/\\.[^.]+\\.twig$/'), 1 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'SimpleAdminBundle', '/Users/emilioalvarez/www/SimpleAdmin/src/SimpleAdmin/Bundle/SimpleAdminBundle/Resources/views', '/\\.[^.]+\\.twig$/'))), 'twig');
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, '', '/Users/emilioalvarez/www/SimpleAdmin/app/Resources/views', '/\\.[^.]+\\.twig$/'), 'twig');
    ...
    {
        return $this->services['assetic.filter_manager'] = new \Symfony\Bundle\AsseticBundle\FilterManager($this, array('cssrewrite' => 'assetic.filter.cssrewrite', 'coffee' => 'assetic.filter.coffee', 'less' => 'assetic.filter.less'));
    }
    ...
    protected function getCacheWarmerService()
    {
        ...
        $c = new \Symfony\Bundle\FrameworkBundle\CacheWarmer\TemplateFinder($a, $b, '/Users/emilioalvarez/www/SimpleAdmin/app/Resources');

        return $this->services['cache_warmer'] = new \Symfony\Component\HttpKernel\CacheWarmer\CacheWarmerAggregate(array(0 => new \Symfony\Bundle\FrameworkBundle\CacheWarmer\TemplatePathsCacheWarmer($c, $this->get('templating.locator')), 1 => new \Symfony\Bundle\AsseticBundle\CacheWarmer\AssetManagerCacheWarmer($this), 2 => new \Symfony\Bundle\FrameworkBundle\CacheWarmer\RouterCacheWarmer($this->get('router')), 3 => new \Symfony\Bundle\TwigBundle\CacheWarmer\TemplateCacheCacheWarmer($this, $c), 4 => new \Symfony\Bridge\Doctrine\CacheWarmer\ProxyCacheWarmer($this->get('doctrine')), 5 => new \JMS\DiExtraBundle\HttpKernel\ControllerInjectorsWarmer($a, $this->get('debug.controller_resolver'), array()), 6 => $this->get('sp_bower.dependency_cache_warmer')));
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('dbname' => 'simpleadmin', 'host' => '127.0.0.1', 'port' => NULL, 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'driver' => 'pdo_mysql', 'driverOptions' => array()), $b, new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this), array());
    }
     ...
     * This method always returns the same instance of the service.
     *
     * @return EntityManager511076a64da0e_546a8d27f194334ee012bfe64f629947b07e4919\__CG__\Doctrine\ORM\EntityManager A EntityManager511076a64da0e_546a8d27f194334ee012bfe64f629947b07e4919\__CG__\Doctrine\ORM\EntityManager instance.
     */
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        require_once '/Users/emilioalvarez/www/SimpleAdmin/app/cache/dev/jms_diextra/doctrine/EntityManager_511076a64da0e.php';

        $a = new \Doctrine\Common\Cache\ApcCache();
        $a->setNamespace('sf2orm_default_edb556111178b20f84fa86f10cb8a6b7');

        $b = new \Doctrine\Common\Cache\ApcCache();
        $b->setNamespace('sf2orm_default_edb556111178b20f84fa86f10cb8a6b7');

        $c = new \Doctrine\Common\Cache\ApcCache();
        $c->setNamespace('sf2orm_default_edb556111178b20f84fa86f10cb8a6b7');

        $d = new \Doctrine\ORM\Mapping\Driver\DriverChain();
        $d->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => '/Users/emilioalvarez/www/SimpleAdmin/src/SimpleAdmin/Bundle/SimpleAdminBundle/Entity')), 'SimpleAdmin\\Bundle\\SimpleAdminBundle\\Entity');

        $e = new \Doctrine\ORM\Configuration();
        $e->setEntityNamespaces(array('SimpleAdminBundle' => 'SimpleAdmin\\Bundle\\SimpleAdminBundle\\Entity'));
        $e->setMetadataCacheImpl($a);
        $e->setQueryCacheImpl($b);
        $e->setResultCacheImpl($c);
        $e->setMetadataDriverImpl($d);
        $e->setProxyDir('/Users/emilioalvarez/www/SimpleAdmin/app/cache/dev/doctrine/orm/Proxies');
        ...
        return $this->services['doctrine.orm.default_entity_manager'] = new \EntityManager511076a64da0e_546a8d27f194334ee012bfe64f629947b07e4919\__CG__\Doctrine\ORM\EntityManager($f, $this);
    }
    ...
    protected function getEventDispatcherService()
    {
        ...
        $instance->addSubscriberService('sp_bower.exec_listener', 'Sp\\BowerBundle\\EventListener\\ExecListener');
        $instance->addSubscriberService('sp_bower.cache_create_listener', 'Sp\\BowerBundle\\EventListener\\CacheCreateListener');
    ...
    {
        return $this->services['file_locator'] = new \Symfony\Component\HttpKernel\Config\FileLocator($this->get('kernel'), '/Users/emilioalvarez/www/SimpleAdmin/app/Resources');
    }
    ...
    {
        return $this->services['form.csrf_provider'] = new \Symfony\Component\Form\Extension\Csrf\CsrfProvider\SessionCsrfProvider($this->get('session'), '06b21ed928841b48c952867133b1f3499eef71d9');
    }
    ...
    {
        return $this->services['fos_rest.format_listener'] = new \FOS\RestBundle\EventListener\FormatListener($this->get('fos_rest.format_negotiator'), 'html', array(0 => 'html', 1 => 'json', 2 => '*/*'), true);
    }
    ...
    protected function getFosRest_SerializerService()
    {
        ...
        $a->setCache(new \Metadata\Cache\FileCache('/Users/emilioalvarez/www/SimpleAdmin/app/cache/dev/jms_serializer'));
    ...
    protected function getJmsDiExtra_Metadata_MetadataFactoryService()
    {
        ...
        $instance->setCache(new \Metadata\Cache\FileCache('/Users/emilioalvarez/www/SimpleAdmin/app/cache/dev/jms_diextra/metadata'));
    ...
    {
        $a = new \Metadata\Driver\FileLocator(array('Symfony\\Bundle\\FrameworkBundle' => '/Users/emilioalvarez/www/SimpleAdmin/vendor/symfony/symfony/src/Symfony/Bundle/FrameworkBundle/Resources/config/serializer', 'Symfony\\Bundle\\SecurityBundle' => '/Users/emilioalvarez/www/SimpleAdmin/vendor/symfony/symfony/src/Symfony/Bundle/SecurityBundle/Resources/config/serializer', 'Symfony\\Bundle\\TwigBundle' => '/Users/emilioalvarez/www/SimpleAdmin/vendor/symfony/symfony/src/Symfony/Bundle/TwigBundle/Resources/config/serializer', 'Symfony\\Bundle\\MonologBundle' => '/Users/emilioalvarez/www/SimpleAdmin/vendor/symfony/monolog-bundle/Symfony/Bundle/MonologBundle/Resources/config/serializer', 'Symfony\\Bundle\\SwiftmailerBundle' => '/Users/emilioalvarez/www/SimpleAdmin/vendor/symfony/swiftmailer-bundle/Symfony/Bundle/SwiftmailerBundle/Resources/config/serializer', 'Symfony\\Bundle\\AsseticBundle' => '/Users/emilioalvarez/www/SimpleAdmin/vendor/symfony/assetic-bundle/Symfony/Bundle/AsseticBundle/Resources/config/serializer', 'Doctrine\\Bundle\\DoctrineBundle' => '/Users/emilioalvarez/www/SimpleAdmin/vendor/doctrine/doctrine-bundle/Doctrine/Bundle/DoctrineBundle/Resources/config/serializer', 'Doctrine\\Bundle\\MigrationsBundle' => '/Users/emilioalvarez/www/SimpleAdmin/vendor/doctrine/doctrine-migrations-bundle/Doctrine/Bundle/MigrationsBundle/Resources/config/serializer', 'Sensio\\Bundle\\FrameworkExtraBundle' => '/Users/emilioalvarez/www/SimpleAdmin/vendor/sensio/framework-extra-bundle/Sensio/Bundle/FrameworkExtraBundle/Resources/config/serializer', 'JMS\\AopBundle' => '/Users/emilioalvarez/www/SimpleAdmin/vendor/jms/aop-bundle/JMS/AopBundle/Resources/config/serializer', 'JMS\\DiExtraBundle' => '/Users/emilioalvarez/www/SimpleAdmin/vendor/jms/di-extra-bundle/JMS/DiExtraBundle/Resources/config/serializer', 'JMS\\SecurityExtraBundle' => '/Users/emilioalvarez/www/SimpleAdmin/vendor/jms/security-extra-bundle/JMS/SecurityExtraBundle/Resources/config/serializer', 'FOS\\RestBundle' => '/Users/emilioalvarez/www/SimpleAdmin/vendor/friendsofsymfony/rest-bundle/FOS/RestBundle/Resources/config/serializer', 'JMS\\SerializerBundle' => '/Users/emilioalvarez/www/SimpleAdmin/vendor/jms/serializer-bundle/JMS/SerializerBundle/Resources/config/serializer', 'Sp\\BowerBundle' => '/Users/emilioalvarez/www/SimpleAdmin/vendor/sp/bower-bundle/Sp/BowerBundle/Resources/config/serializer', 'SimpleAdmin\\Bundle\\SimpleAdminBundle' => '/Users/emilioalvarez/www/SimpleAdmin/src/SimpleAdmin/Bundle/SimpleAdminBundle/Resources/config/serializer', 'Symfony\\Bundle\\WebProfilerBundle' => '/Users/emilioalvarez/www/SimpleAdmin/vendor/symfony/symfony/src/Symfony/Bundle/WebProfilerBundle/Resources/config/serializer', 'Sensio\\Bundle\\DistributionBundle' => '/Users/emilioalvarez/www/SimpleAdmin/vendor/sensio/distribution-bundle/Sensio/Bundle/DistributionBundle/Resources/config/serializer', 'Sensio\\Bundle\\GeneratorBundle' => '/Users/emilioalvarez/www/SimpleAdmin/vendor/sensio/generator-bundle/Sensio/Bundle/GeneratorBundle/Resources/config/serializer'));
    ...
    {
        return $this->services['monolog.handler.main'] = new \Monolog\Handler\StreamHandler('/Users/emilioalvarez/www/SimpleAdmin/app/logs/dev.log', 100, true);
    }
    ...
    protected function getProfilerService()
    {
        ...
        $this->services['profiler'] = $instance = new \Symfony\Component\HttpKernel\Profiler\Profiler(new \Symfony\Component\HttpKernel\Profiler\FileProfilerStorage('file:/Users/emilioalvarez/www/SimpleAdmin/app/cache/dev/profiler', '', '', 86400), $a);
    ...
    {
        return $this->services['router'] = new \Symfony\Bundle\FrameworkBundle\Routing\Router($this, '/Users/emilioalvarez/www/SimpleAdmin/app/config/routing_dev.yml', array('cache_dir' => '/Users/emilioalvarez/www/SimpleAdmin/app/cache/dev', 'debug' => true, 'generator_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_base_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_dumper_class' => 'Symfony\\Component\\Routing\\Generator\\Dumper\\PhpGeneratorDumper', 'generator_cache_class' => 'appdevUrlGenerator', 'matcher_class' => 'Symfony\\Bundle\\FrameworkBundle\\Routing\\RedirectableUrlMatcher', 'matcher_base_class' => 'Symfony\\Bundle\\FrameworkBundle\\Routing\\RedirectableUrlMatcher', 'matcher_dumper_class' => 'Symfony\\Component\\Routing\\Matcher\\Dumper\\PhpMatcherDumper', 'matcher_cache_class' => 'appdevUrlMatcher', 'strict_requirements' => true), $this->get('router.request_context'), $this->get('monolog.logger.router'));
    }
    ...
    protected function getSecurity_Access_DecisionManagerService()
    {
        ...
        $a->setCacheDir('/Users/emilioalvarez/www/SimpleAdmin/app/cache/dev/jms_security/expressions');
    ...
    {
        return $this->services['sensio.distribution.webconfigurator'] = new \Sensio\Bundle\DistributionBundle\Configurator\Configurator('/Users/emilioalvarez/www/SimpleAdmin/app');
    }
    ...
    {
        return $this->services['session.handler'] = new \Symfony\Component\HttpFoundation\Session\Storage\Handler\NativeFileSessionHandler('/Users/emilioalvarez/www/SimpleAdmin/app/cache/dev/sessions');
    }
    ...
    {
        return $this->services['session.storage.filesystem'] = new \Symfony\Component\HttpFoundation\Session\Storage\MockFileSessionStorage('/Users/emilioalvarez/www/SimpleAdmin/app/cache/dev/sessions');
    }
    ...
    /**
     * Gets the 'sp_bower.assetic.bower_resource' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return Sp\BowerBundle\Assetic\BowerResource A Sp\BowerBundle\Assetic\BowerResource instance.
     */
    protected function getSpBower_Assetic_BowerResourceService()
    {
        return $this->services['sp_bower.assetic.bower_resource'] = new \Sp\BowerBundle\Assetic\BowerResource($this->get('sp_bower.bower'), $this->get('sp_bower.bower_manager'));
    }

    /**
     * Gets the 'sp_bower.bower' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return Sp\BowerBundle\Bower\Bower A Sp\BowerBundle\Bower\Bower instance.
     */
    protected function getSpBower_BowerService()
    {
        return $this->services['sp_bower.bower'] = new \Sp\BowerBundle\Bower\Bower('/usr/bin/bower', $this->get('sp_bower.filesystem_cache'), $this->get('event_dispatcher'));
    }

    /**
     * Gets the 'sp_bower.bower_manager' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return Sp\BowerBundle\Bower\BowerManager A Sp\BowerBundle\Bower\BowerManager instance.
     */
    protected function getSpBower_BowerManagerService()
    {
        $a = new \Sp\BowerBundle\Bower\Configuration('/Users/emilioalvarez/www/SimpleAdmin/src/SimpleAdmin/Bundle/SimpleAdminBundle/Resources/config/bower');
        $a->setAssetDirectory('/Users/emilioalvarez/www/SimpleAdmin/src/SimpleAdmin/Bundle/SimpleAdminBundle/Resources/config/bower/Resources/public/components');
        $a->setJsonFile('component.json');
        $a->setEndpoint('https://bower.herokuapp.com');

        $this->services['sp_bower.bower_manager'] = $instance = new \Sp\BowerBundle\Bower\BowerManager();

        $instance->addBundle('SimpleAdminBundle', $a);

        return $instance;
    }

    /**
     * Gets the 'sp_bower.cache_create_listener' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return Sp\BowerBundle\EventListener\CacheCreateListener A Sp\BowerBundle\EventListener\CacheCreateListener instance.
     */
    protected function getSpBower_CacheCreateListenerService()
    {
        return $this->services['sp_bower.cache_create_listener'] = new \Sp\BowerBundle\EventListener\CacheCreateListener($this->get('sp_bower.bower'));
    }

    /**
     * Gets the 'sp_bower.dependency_cache_warmer' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return Sp\BowerBundle\CacheWarmer\DependencyCacheWarmer A Sp\BowerBundle\CacheWarmer\DependencyCacheWarmer instance.
     */
    protected function getSpBower_DependencyCacheWarmerService()
    {
        return $this->services['sp_bower.dependency_cache_warmer'] = new \Sp\BowerBundle\CacheWarmer\DependencyCacheWarmer($this->get('sp_bower.bower_manager'), $this->get('sp_bower.bower'), false);
    }

    /**
     * Gets the 'sp_bower.exec_listener' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return Sp\BowerBundle\EventListener\ExecListener A Sp\BowerBundle\EventListener\ExecListener instance.
     */
    protected function getSpBower_ExecListenerService()
    {
        return $this->services['sp_bower.exec_listener'] = new \Sp\BowerBundle\EventListener\ExecListener('/Users/emilioalvarez/www/SimpleAdmin/app/cache/dev/sp_bower');
    }

    /**
     * Gets the 'sp_bower.filesystem_cache' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     */
    protected function getSpBower_FilesystemCacheService()
    {
        return $this->services['sp_bower.filesystem_cache'] = new \Doctrine\Common\Cache\FilesystemCache('/Users/emilioalvarez/www/SimpleAdmin/app/cache/dev/sp_bower', '.sp_bower.data');
    }
    ...
    {
        return $this->services['templating.helper.code'] = new \Symfony\Bundle\FrameworkBundle\Templating\Helper\CodeHelper(NULL, '/Users/emilioalvarez/www/SimpleAdmin/app', 'UTF-8');
    }
    ...
    {
        return $this->services['translator.default'] = new \Symfony\Bundle\FrameworkBundle\Translation\Translator($this, $this->get('translator.selector'), array('translation.loader.php' => array(0 => 'php'), 'translation.loader.yml' => array(0 => 'yml'), 'translation.loader.xliff' => array(0 => 'xlf', 1 => 'xliff'), 'translation.loader.po' => array(0 => 'po'), 'translation.loader.mo' => array(0 => 'mo'), 'translation.loader.qt' => array(0 => 'ts'), 'translation.loader.csv' => array(0 => 'csv'), 'translation.loader.res' => array(0 => 'res'), 'translation.loader.dat' => array(0 => 'dat'), 'translation.loader.ini' => array(0 => 'ini')), array('cache_dir' => '/Users/emilioalvarez/www/SimpleAdmin/app/cache/dev/translations', 'debug' => true));
    }
    ...
    protected function getTwigService()
    {
        ...
        $this->services['twig'] = $instance = new \Twig_Environment($this->get('twig.loader'), array('debug' => true, 'strict_variables' => true, 'exception_controller' => 'Symfony\\Bundle\\TwigBundle\\Controller\\ExceptionController::showAction', 'cache' => '/Users/emilioalvarez/www/SimpleAdmin/app/cache/dev/twig', 'charset' => 'UTF-8', 'paths' => array()));
        ...
        $instance->addExtension(new \Symfony\Bundle\AsseticBundle\Twig\AsseticExtension($this->get('assetic.asset_factory'), $this->get('templating.name_parser'), false, array(), array(0 => 'SimpleAdminBundle'), new \Symfony\Bundle\AsseticBundle\DefaultValueSupplier($this)));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath('/Users/emilioalvarez/www/SimpleAdmin/vendor/symfony/symfony/src/Symfony/Bridge/Twig/Resources/views/Form');
     ...
     *
     * @return EntityManager511076a64da0e_546a8d27f194334ee012bfe64f629947b07e4919\__CG__\Doctrine\ORM\EntityManager An instance of the doctrine.orm.default_entity_manager service
     */
    ...
    /**
     * Gets the jms_serializer service alias.
     *
     * @return JMS\Serializer\Serializer An instance of the fos_rest.serializer service
     */
    ...
    {
        $this->services['assetic.asset_factory'] = $instance = new \Symfony\Bundle\AsseticBundle\Factory\AssetFactory($this->get('kernel'), $this, $this->getParameterBag(), '/Users/emilioalvarez/www/SimpleAdmin/app/../web', true);
    ...
    {
        $this->services['security.extra.metadata_factory'] = $instance = new \Metadata\MetadataFactory(new \Metadata\Driver\LazyLoadingDriver($this, 'security.extra.metadata_driver'), new \Metadata\Cache\FileCache('/Users/emilioalvarez/www/SimpleAdmin/app/cache/dev/jms_security', true));
    ...
    {
        return $this->services['templating.locator'] = new \Symfony\Bundle\FrameworkBundle\Templating\Loader\TemplateLocator($this->get('file_locator'), '/Users/emilioalvarez/www/SimpleAdmin/app/cache/dev');
    }
    ...
    {
        return $this->services['validator.mapping.class_metadata_factory'] = new \Symfony\Component\Validator\Mapping\ClassMetadataFactory(new \Symfony\Component\Validator\Mapping\Loader\LoaderChain(array(0 => new \Symfony\Component\Validator\Mapping\Loader\AnnotationLoader($this->get('annotation_reader')), 1 => new \Symfony\Component\Validator\Mapping\Loader\StaticMethodLoader(), 2 => new \Symfony\Component\Validator\Mapping\Loader\XmlFilesLoader(array(0 => '/Users/emilioalvarez/www/SimpleAdmin/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/config/validation.xml')), 3 => new \Symfony\Component\Validator\Mapping\Loader\YamlFilesLoader(array()))), NULL);
    }
    ...
    {
        return array(
            'kernel.root_dir' => '/Users/emilioalvarez/www/SimpleAdmin/app',
            'kernel.environment' => 'dev',
            'kernel.debug' => true,
            'kernel.name' => 'app',
            'kernel.cache_dir' => '/Users/emilioalvarez/www/SimpleAdmin/app/cache/dev',
            'kernel.logs_dir' => '/Users/emilioalvarez/www/SimpleAdmin/app/logs',
            'kernel.bundles' => array(
                ...
                'SpBowerBundle' => 'Sp\\BowerBundle\\SpBowerBundle',
                'SimpleAdminBundle' => 'SimpleAdmin\\Bundle\\SimpleAdminBundle\\SimpleAdminBundle',
            ...
            'locale' => 'en',
            'secret' => '06b21ed928841b48c952867133b1f3499eef71d9',
            'database_path' => NULL,
            ...
            'debug.container.dump' => '/Users/emilioalvarez/www/SimpleAdmin/app/cache/dev/appDevDebugProjectContainer.xml',
            'debug.controller_resolver.class' => 'Symfony\\Bundle\\FrameworkBundle\\Controller\\TraceableControllerResolver',
            'kernel.secret' => '06b21ed928841b48c952867133b1f3499eef71d9',
            ...
            'session.save_path' => '/Users/emilioalvarez/www/SimpleAdmin/app/cache/dev/sessions',
            ...
            'validator.mapping.loader.xml_files_loader.mapping_files' => array(
                0 => '/Users/emilioalvarez/www/SimpleAdmin/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/config/validation.xml',
            ),
            ...
            'profiler.storage.dsn' => 'file:/Users/emilioalvarez/www/SimpleAdmin/app/cache/dev/profiler',
            ...
            'router.resource' => '/Users/emilioalvarez/www/SimpleAdmin/app/config/routing_dev.yml',
            ...
            'twig.options' => array(
                ...
                'cache' => '/Users/emilioalvarez/www/SimpleAdmin/app/cache/dev/twig',
                'charset' => 'UTF-8',
                'paths' => array(
            ...
            'swiftmailer.spool.memory.path' => '/Users/emilioalvarez/www/SimpleAdmin/app/cache/dev/swiftmailer/spool',
            ...
            'assetic.cache_dir' => '/Users/emilioalvarez/www/SimpleAdmin/app/cache/dev/assetic',
            ...
            'assetic.read_from' => '/Users/emilioalvarez/www/SimpleAdmin/app/../web',
            'assetic.write_to' => '/Users/emilioalvarez/www/SimpleAdmin/app/../web',
            ...
            'doctrine.orm.proxy_dir' => '/Users/emilioalvarez/www/SimpleAdmin/app/cache/dev/doctrine/orm/Proxies',
            'doctrine.orm.proxy_namespace' => 'Proxies',
            'doctrine_migrations.dir_name' => '/Users/emilioalvarez/www/SimpleAdmin/app/DoctrineMigrations',
            ...
            'jms_aop.cache_dir' => '/Users/emilioalvarez/www/SimpleAdmin/app/cache/dev/jms_aop',
            ...
            'jms_di_extra.cache_dir' => '/Users/emilioalvarez/www/SimpleAdmin/app/cache/dev/jms_diextra',
            'jms_di_extra.disable_grep' => false,
            'jms_di_extra.doctrine_integration' => true,
            'jms_di_extra.cache_warmer.controller_file_blacklist' => array(

            ),
            'jms_di_extra.doctrine_integration.entity_manager.file' => '/Users/emilioalvarez/www/SimpleAdmin/app/cache/dev/jms_diextra/doctrine/EntityManager_511076a64da0e.php',
            'jms_di_extra.doctrine_integration.entity_manager.class' => 'EntityManager511076a64da0e_546a8d27f194334ee012bfe64f629947b07e4919\\__CG__\\Doctrine\\ORM\\EntityManager',
            ...
            'security.extra.cache_dir' => '/Users/emilioalvarez/www/SimpleAdmin/app/cache/dev/jms_security',
            ...
            'fos_rest.cache_dir' => '/Users/emilioalvarez/www/SimpleAdmin/app/cache/dev/fos_rest',
            ...
            'sp_bower.install_on_warmup' => false,
            'sp_bower.bower.class' => 'Sp\\BowerBundle\\Bower\\Bower',
            'sp_bower.bower_manager.class' => 'Sp\\BowerBundle\\Bower\\BowerManager',
            'sp_bower.bower.configuration.class' => 'Sp\\BowerBundle\\Bower\\Configuration',
            'sp_bower.bower.bin' => '/usr/bin/bower',
            'sp_bower.file_resource.class' => 'Symfony\\Component\\Config\\Resource\\FileResource',
            'sp_bower.directory_resource.class' => 'Symfony\\Component\\Config\\Resource\\DirectoryResource',
            'sp_bower.filesystem_cache.class' => 'Doctrine\\Common\\Cache\\FilesystemCache',
            'sp_bower.dependency_cache_warmer.class' => 'Sp\\BowerBundle\\CacheWarmer\\DependencyCacheWarmer',
            'sp_bower.exec_listener.class' => 'Sp\\BowerBundle\\EventListener\\ExecListener',
            'sp_bower.cache_create_listener.class' => 'Sp\\BowerBundle\\EventListener\\CacheCreateListener',
            'sp_bower.assetic.bower_resource.class' => 'Sp\\BowerBundle\\Assetic\\BowerResource',
            'sp_bower.cache_dir' => '/Users/emilioalvarez/www/SimpleAdmin/app/cache/dev/sp_bower',
